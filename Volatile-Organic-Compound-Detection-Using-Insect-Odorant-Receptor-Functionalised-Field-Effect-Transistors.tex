...
\(\times\) \(10^{-7}\) V across both the forward and reverse sweep. Some
devices exhibited a double-minima feature, indicating the presence of
two Dirac points. This effect arises due to doping of graphene by the
...
\autocite{Bartolomeo2011,Feng2014,Peng2018}. Hysteresis between the
forward and reverse sweep results from charge traps in and on the
surface of the SiO\(_2\) dielectric \autocite{Bartolomeo2011}.
...
times successively. Table~\ref{tbl-graphene-parameters} shows that the
on-off ratio and major Dirac point voltage of graphene devices were
highly consistent before and after exposure to 1XPBS, indicating the
presence of 1XPBS had minimal impact on these key parameters. Exposure
to 1XPBS does not appear to impact the appearance of double-minima when
...
to 1XPBS. Electrical characteristics were taken of 6 channels total,
three channels from each of two devices. }\tabularnewline
...
Note that the major Dirac point for these devices is slightly to the
right of the intrinsic Dirac point voltage, V\(_{\textrm{Dirac}}\)
\(\sim\) 0. This slight \(p\)-doping is likely a result of a adsorption
of oxygen and water from the air and residue resist from
photolithography \autocite{Cheng2011,Shin2012}.
