...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, frame hidden, interior hidden, sharp corners, enhanced, boxrule=0pt]}{\end{tcolorbox}}\fi
...
by Chen \emph{et al.} \autocite{Chen2001,Campos2019}. Two methods for
protein functionalisation were successfully used, with the only
...
1 mM respectively). The lower concentration may have been used for PBASE
in methanol as PBASE appears to dissolve poorly in methanol at higher
...
Table~\ref{tbl-pbase-functionalisation} \cite{Chen2001} . \ldots{}
directly cite Chen \emph{et al.} when discussing functionalisation with
PBASE.
...
2-Methoxyethanol & Graphene & 1 & Immersed & 1 & DI water & Ono et
al. \\
Methanol & CNTs & 1 & Immersed & 1 & Methanol, DI water & Zheng et
al. \\
