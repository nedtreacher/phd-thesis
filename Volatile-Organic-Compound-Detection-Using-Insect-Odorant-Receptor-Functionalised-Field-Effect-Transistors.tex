...
across all channels. In contrast, the signal changes at all other
addition times were fairly consistent, despite each addition causing a
lower change in concentration than the ones before. The threshold shift
due to electrostatic gating should be proportional to the logarithm of
final salt concentration, and therefore proportional to signal change in
the linear on-regime \autocite{Heller2010}. This relationship cannot
sufficiently explain the very large response Insufficient mixing with
existing solution of a specific addition in the tightly enclosed PDMS
well environment may result in a reduced response. Subsequent additions
may be more likely to cause mixing, leading to a greater change in
concentration at the surface of the channel and a larger response.
...
current, (b) and (c) appear as shown in (e) and (f) respectively.}
...
\tightlist
\item
  and (f) account for the difference in drift between channels, show
  they are consistent when drift accounted for
\end{enumerate}
