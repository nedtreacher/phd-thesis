...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, interior hidden, sharp corners, enhanced, frame hidden, borderline west={3pt}{0pt}{shadecolor}, breakable]}{\end{tcolorbox}}\fi
...
\includegraphics{figures/ch6/withplasma_surfactantrinse_Dirac_shift_comparisons_0_mPEGpyrene.png}

}

}

\subcaption{\label{fig-pypeg-dirac-shift-no-plasma}}
\end{minipage}%
%
\begin{minipage}[t]{0.05\linewidth}
...
\includegraphics{figures/ch6/withplasma_surfactantrinse_Dirac_shift_comparisons_2_mPEGpyrene.png}
...
\includegraphics{figures/ch6/withplasma_surfactantrinse_Dirac_shift_comparisons_3_mPEGpyrene.png}
