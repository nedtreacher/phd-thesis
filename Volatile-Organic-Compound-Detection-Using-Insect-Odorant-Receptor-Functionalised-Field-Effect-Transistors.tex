...
layer could be deposited, as seen in Figure~\ref{fig-SU8-encapsulation}.
The AZ\(^\circledR\) 1518 encapsulation layer had a height of 1.7
\(\pm\) 0.2 \(\mu\)m, while the SU-8 encapsulation layer had a height of
680 \(\pm\) 20 nm. The SU-8 also had less significant edge features than
the AZ\(^\circledR\) 1518. However, the exposed region was reduced for
the SU-8 encapsulation relative to the AZ\(^\circledR\) 1518, with an
width of only 3.6 \(\pm\) 0.5 \(\mu\)m for the pre-2023 mask.
...
encapsulation. This meant using the new mask from 2023 was especially
important for maximising the exposed channel region with SU-8 devices.
Using the new mask from 2023 with the SU-8 resist gave a significantly
improved exposed region width of 13.8 \(\pm\) 1.0 \(\mu\)m.
...
was used to analyse AFM images.
