...
{\centering \includegraphics[width=0.45\textwidth,height=\textheight]{figures/ch6/comparison_raman.png}
...
submerged in DMSO containing 5 mM PBA for 1 hour, (b) after being
submerged in 1XPBS containing 20 mM EDC and 40 mM NHS for 30 min, and
(c) after being submerged in fresh 1XPBS for 1 hour. The linear fits to
each characteristic curve are shown in (d), alongside the threshold
voltages calculated by finding the intercept of each fit.}

\end{figure}

Figure~\ref{fig-pba-functionalisation-threshold-shift} shows the
transfer characteristics of a carbon nanotube transistor at various
stages of a PBA/EDC functionalisation, where a excess of
