...
\caption{\label{fig-OR-GFP-surfactant}Image (a) and (b) show
fluorescence images of an unencapsulated carbon nanotube channel after
functionalisation with 1 \(\mu\)L/mL GFP-OR43b nanodiscs in 1XPBS using
pyrene-PEG-NTA linker. Images (c) and (d) also shows channels
functionalised with 1 \(\mu\)L/mL GFP-OR43b, but where the device was
rinsed with surfactant after pyrene-PEG-NTA attachment. Image (c) is
...
Pyrene-PEG-NTA are shown in \textbf{?@fig-PPN-GFP-ORs}. Similar
...
Figure~\ref{fig-OR-GFP-surfactant} shows fluorescence microscope images
of the device after functionalisation with GFP-OR43b.
