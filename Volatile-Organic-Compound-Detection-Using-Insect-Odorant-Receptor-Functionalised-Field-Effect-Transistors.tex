...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}, breakable, frame hidden, sharp corners]}{\end{tcolorbox}}\fi
...
\subcaption{\label{fig-sigma-nmr}Sigma NMR}
\end{minipage}%
\newline
\begin{minipage}[t]{\linewidth}
...
\subcaption{\label{fig-setareh-nmr}Setareh NMR}
\end{minipage}%
\newline
\begin{minipage}[t]{\linewidth}
...
\subcaption{\label{fig-dmso-nmr}Blank (DMSO only) NMR}
\end{minipage}%
