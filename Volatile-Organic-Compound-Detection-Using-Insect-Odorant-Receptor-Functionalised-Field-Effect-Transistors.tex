...
full-scale MFC through the carrier line in (a) and the 500 sccm
full-scale MFC through the dilution line in (b). Three water
displacement tests were performed for each constant flow rate. A strong
linear relationship between nominal and actual flows was identified
using least-squares methods, with an R-squared value of 0.98 for the
trendline in (a) and 0.997 for the trendline in (b).}
...
sccm MFC flow through the carrier line, values of \(a_1 = 1.18\pm0.09\)
and \(a_2 = -1\pm13\) were obtained, while for the 500 sccm MFC flow
through the dilution line, values of \(a_1 = 1.16\pm0.04\) and
\(a_2 = -5\pm10\) were obtained.
