...
height profile for the different adhesion layers used}
\end{minipage}%
%
\begin{minipage}[t]{0.05\linewidth}
...
height profile for the different photoresist types used}
\end{minipage}%
...
O\(_2\) plasma at 50 W for at least 2-5 s or at 20 W for 20-25 s in a
PE-50 plasma cleaner (Plasma Etch, Inc.) to remove residual photoresist
on the developed regions and ensure a clean lift-off.

As with the alignment markers deposition (see Section~\ref{sec-align}),
before Jun 2022 chromium was used for the gold adhesive layer, and after
Jun 2022 titanium was used. A 20 nm nominal titanium layer instead of 10
nm nominal was found to give better electrode adhesion, and devices
after Feb 2023 were made using this thicker adhesion layer. Good
electronic contact could be made with electrodes with a nominal gold
layer thickness of 60-100 nm (see
...
sensing. A side-by-side microscope comparison of hardbaked
AZ\(^\circledR\) 1518 processed with each mask is given in
Figure~\ref{fig-microscope-encapsulation}, while a Dektat profile
comparison is shown in Figure~\ref{fig-old-new-mask}.
...
AZ\(^\circledR\) 1518 and SU-8 2150.}
...
\autocite{Lee2006,Chen2021,Albarghouthi2022}. A much thinner coating was
achievable with SU-8, as shown in
Figure~\ref{fig-1518-SU8-encapsulation}.
