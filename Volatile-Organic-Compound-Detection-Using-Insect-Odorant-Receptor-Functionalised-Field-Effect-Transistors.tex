...
4-inch \(p\)-type (B-doped) silicon wafers with a 300 nm SiO\(_2\) layer
(WaferPro LLC) were used as a substrate for carbon nanotube network
deposition.
...
positive and negative photoresists (also known as ``resists'').
Photolithography with the positive resist used here required a single
softbake step, while with negative resists a second \textcite{Microchem}
