...
carbon nanotube field-effect transistors shown next to two individual
devices. Partial (unusable) devices at the edges of the wafer have been
cleaved off so that only a square of nine devices remains. The schematic
in Figure~\ref{fig-device-schematic} labels the component parts of the
individual FET device after the full photolithographic process is
completed.
...
\caption{\label{fig-field-effect-transistor}The component parts of the
field-effect transistor are labelled in the schematic in (a). A finished
quarter-wafer with the unusable edges cleaved off is shown in (b), while
an individual carbon nanotube field-effect transistor device is shown in
(c).}
...
surface is seen in (a), followed by microscope images of the PDMS
surface before (b) and after (c) isopropanol (IPA) sonication for 10
minutes.}
