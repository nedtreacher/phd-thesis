...
\bottomrule\noalign{}
\endlastfoot
DMF & CNT & 5 & Immersed & 1 & PBS & Maehashi \textit{et al.}, 2007.
\cite{Maehashi2007} \\
& & 6 & Immersed & 1 & DMF, PBS & García-Aljaro \textit{et al.}, 2010.
\cite{Garcia-Aljaro2010} \\
& & 6 & Immersed & 1 & DMF & Chen \textit{et al.}, 2001.
\cite{Chen2001} \\
& & 6 & Immersed & 1 & DMF & Cella \textit{et al.}, 2010.
\cite{Cella2010} \\
& & 6 & Immersed & 1 & DMF & Das \textit{et al.}, 2011.
\cite{Das2011} \\
& & 6 & - & 2 & DMF & Besteman \textit {et al.}, 2003.
\cite{Besteman2003} \\
& Graphene & - & - & 2 & DMF & Kwong Hong Tsang \textit{et al.}, 2019.
\cite{KwongHongTsang2019} \\
& & - & - & 20 & - & Wiedman \textit{et al.}, 2017.
\cite{Wiedman2017} \\
& & 0.2 & Immersed & 20 & DMF, IPA, DI water & Gao \textit{et al.},
2018. \cite{Gao2018} \\
& & 1 & 100 \(\mu\)L droplet & 6 & DMF, IPA, DI water & Nekrasov
\textit{et al.}, 2021. \cite{Nekrasov2021} \\
& & 5 & Immersed & 1 & DMF, DI water & Hwang \textit{et al.}, 2016.
\cite{Hwang2016} \\
& & 5* & Immersed & 3* & DMF & Hao \textit{et al.}, 2020.
\cite{Hao2020} \\
& & 5 & Immersed & 4* & DMF, DI water & Mishyn \textit{et al.}, 2022.
\cite{Mishyn2022} \\
& & 6 & 6 \(\mu\)L droplet & 2 & DMF, DI water & Nur Nasufiya
\textit{et al.}, 2020. \cite{NurNasyifa2020} \\
& & 10 & 10 \(\mu\)L droplet & 2 & DMF, DI water & Campos
\textit{et al.}, 2019. \cite{Campos2019} \\
& & 10 & Immersed & 2 & DMF, PBS & Kuscu \textit{et al.}, 2020.
\cite{Kuscu2020} \\
& & 10 & Immersed & 1 & DMF & Xu \textit{et al.}, 2017. \cite{Xu2017} \\
& & 10 & Immersed & 12 & DMF, EtOH, DI water & Khan \textit{et al.},
2020. \cite{Khan2020} \\
& & 50 & Immersed & 4* & MeOH & Wang \textit{et al.}, 2020.
\cite{Wang2020} \\
2-Methoxyethanol & Graphene & 1 & Immersed & 1 & DI water & Ono
\textit{et al.}, 2020. \cite{Ono2020} \\
Methanol & CNT & 1 & Immersed & 1 & MeOH, DI water & Zheng
\textit{et al.}, 2016. \cite{Zheng2016} \\
& & 1 & Immersed & 2 & MeOH & Kim \textit{et al.}, 2009.
\cite{Kim2009} \\
& & 100 & 2 \(\mu\)L droplet & 1 & DI water & Yoo \textit{et al.}, 2022.
\cite{Yoo2022} \\
& Graphene & 5 & Immersed & 2 & - & Sethi \textit{et al.}, 2020.
\cite{Sethi2020} \\
& & 5 & Immersed & 1 & MeOH, PBS & Ohno \textit{et al.}, 2010.
\cite{Ohno2010} \\
DMSO & CNT & 10 & - & 1 & DI water & Lopez \textit{et al.}, 2015.
\cite{Lopez2015} \\
& & 10 & Immersed & 1 & PBS & Strack \textit{et al.}, 2013.
\cite{Strack2013} \\
\end{longtable}
...
\toprule\noalign{}
Solvent & Channel & PBA (mM) & Exposure (hr) & EDC (mM) & NHS (mM) &
Exposure (min) & References \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
Solvent & Channel & PBA (mM) & Exposure (hr) & EDC (mM) & NHS (mM) &
...
2016. \cite{Gao2016} \\
& & 5 & 2 & 2 & 5 & 30 & Mishyn \textit{et al.}, 2022.
\cite{Mishyn2022} \\
& CNT & 100 & 3 & 200 & - & 30 & Min \textit{et al.}, 2012.
\cite{Min2012} \\
& Graphene, CNT & 7.6 & 2 & 8 & 20 & 120 & Xu \textit{et al.}, 2014.
\cite{Xu2014} \\
DI water & CNT & - & - & 32 & 12 & Overnight & Pacios
\textit{et al.}\(^†\), 2012. \cite{Pacios2012} \\
Ethanol & CNT & 1 & 1 & 100 & 100 & 20 & Filipiak \textit{et al.}\(^†\),
2018. \cite{Filipiak2018} \\
Acetonitrile & Graphene & 1 & 1 & 400 & 100 & 60 & Tong
\textit{et al.}\(^{††}\), 2020. \cite{Tong2020} \\
Borax & CNT & 2 & 24 & 2.5 & - & 1080 & Liu \textit{et al.}\(^†\), 2011.
\cite{Liu2011} \\
DMSO & Graphene & 5 & 1 & 50 & 50 & 90 & Fenzl \textit{et al.}, 2017.
\cite{Fenzl2017} \\
\end{longtable}
...
taken from the same wafer. The DMSO solution on one film contained PBA,
the solution on another film contained PBASE, and the DMSO on the final
film contained no linker molecule. After incubation for 1 hour, films
were rinsed for 15 s with DMSO, then for 15 s with IPA to remove excess
DMSO while avoiding hydrolysis of the PBASE. After the first set of
Raman spectra was taken, the film initially exposed to PBA was further
exposed to a solution of 20 mM EDC and 40 mM NHS in 1XPBS electrolyte
for 30 minutes, and a second set of Raman spectra was taken for this
film. As in \textbf{?@sec-pristine-raman}, spectra were processed
according to Section~\ref{sec-raman-analysis}, and the silicon dioxide
reference peak measured in the wavenumber range 100 cm\(^{-1}\) \(-\)
650 cm\(^{-1}\) was used to normalise the D-band and G-band peaks from
the wavenumber range 1300 cm\(^{-1}\) \(-\) 1650 cm\(^{-1}\). The ratio
between the average intensity of the D-peak and the G\(^+\)-peak at each
position was calculated, and the distribution of ratio values
corresponding to each modified film is shown in
...
\textbf{?@fig-raman-comparison}, there is signficant overlap between
I\(_D\)/I\(_G\) measurements for both PBA and PBASE. Furthermore, after
further functionalisation of the PBA-modified film with EDC/NHS,
subsequent Raman measurements of the film do not differ significantly to
measurements taken before adding the EDC/NHS. These results indicate
that presence of the NHS ester has little effect on the Raman shift.
Therefore, it should be clarified that Raman spectroscopy cannot be used
to distinguish between the presence of PBA and PBASE on the device
surface.
...
mM NHS in 1XPBS electrolyte for 30 minutes.
Figure~\ref{fig-pba-threshold-shift} to
Figure~\ref{fig-PBASE-vs-solvent-only} can be compared for a better
understanding of the electrical impact of both the PBASE and the PBA/EDC
functionalisation methods. The threshold shift with the addition of 5 mM
PBA in DMSO for 1 hour is equivalent to the shift seen when only DMSO is
added, \(\Delta\)V = -0.15 V. The lack of a significant threshold shift
is a result of pyrene having a neutral charge state, and any
contributions from the charged carboxyl group being screened from the
...
network \autocite{Murugathas2019b}. When EDC/NHS is added, a further
increase in mobility of channel holes is seen \autocite{Heller2008}.
...
carbon nanotube or graphene surface, pyrene-PEG modified with
fluorescein isothiocyanate was used, a widely-used fluorescent probe
which does not specifically interact with carbon rings.
...
\(\pi\)-stack with carbon rings \autocite{Tang2012}. As it is the
attachment of pyrene which is of interest, rather than attachment of the
fluorescent modifier, FITC was used instead of Rhodamine B.
...
\includegraphics{figures/ch6/modified_noencap_1mMPPF_channel2_1sexposure_6.3X_highcontrast_221214.png}
...
\includegraphics{figures/ch6/modified_noencap_1mMPPF_channel7_1sexposure_6.3X_highcontrast_221214.png}
...
shift at higher concentrations of pyrene-PEG. Since aqueous
...
assumed that this shift is due to attachment of pyrene-PEG to the small
...
\includegraphics{figures/ch6/modified_SU8only_FITCfilter_channel2_4.5s_12.6X_221207.png}
