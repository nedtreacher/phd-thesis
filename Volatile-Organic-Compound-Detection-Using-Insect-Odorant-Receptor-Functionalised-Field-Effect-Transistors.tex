...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, enhanced, breakable, frame hidden, interior hidden, borderline west={3pt}{0pt}{shadecolor}, sharp corners]}{\end{tcolorbox}}\fi
...
\subcaption{\label{fig-dektat-adhesion-layer}Adhesion layer type dektat}
\end{minipage}%
%
\begin{minipage}[t]{0.05\linewidth}
...
\subcaption{\label{fig-dektat-photoresist-used}Photoresist type dektat}
\end{minipage}%
