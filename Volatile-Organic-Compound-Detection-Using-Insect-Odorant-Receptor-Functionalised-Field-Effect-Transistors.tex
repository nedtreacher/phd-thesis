...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, borderline west={3pt}{0pt}{shadecolor}, frame hidden, boxrule=0pt, interior hidden, breakable, enhanced]}{\end{tcolorbox}}\fi
...
substrate height was \(11.32\pm0.9\) nm. A binary representation of the
image taken at the minimum height no spindle-like bundles were visible,
34.7 nm, is shown in Figure~\ref{fig-solvent-deposited-AFM-comparison}
...
\autocite{Murugathas2020} than previously seen in this work. The
aggregates can be at least 340 nm tall, as seen in
Figure~\ref{fig-solvent-deposited-AFM-comparison} (c) and (d). The
aggregates appear to form clusters over a larger scale, perhaps
indicating mutual interaction during deposition.
