...
\subcaption{\label{fig-overcut-profile}Damage to gold electrode in
...
\subcaption{\label{fig-undercut-profile}Damage to graphene after DMSO
lift-off}
\end{minipage}%

\caption{\label{fig-dmso-damage}Lift-off with dimethyl sulfoxide
sometimes led to damage to regions where nanomaterials were present. It
is possible that sometimes residual photoresist on the nanomaterial was
crosslinked during electrode deposition, and then during lift-off was
removed aggressively alongside attached nanomaterial by the DMSO.
...
was the preferred agent for lift-off despite being less efficient than
DMSO.}
...
detailed in Section~\ref{sec-AFM-characterisation}. From Jul 2023
onwards, after each photolithography step, quarter wafers/chips were
flood exposed to UV light for 1 min and then placed in AZ326 developer
for 3 min to ensure complete removal of photoresist residue (discussed
in Section~\ref{sec-fluorescence-characterisation}).
...
marker. For carbon nanotube quarter wafers, alignment markers were
deposited either directly before or after carbon nanotube deposition
(see Section~\ref{sec-dep-carbon-nanotubes} for discussion). For
graphene devices, alignment markers were deposited directly after
...
lift-off and improved gold adhesion. A thinner gold layer (50 nm nominal
instead of 100 nm) proved to still be clearly visible but used less gold
in the deposition process and led to a cleaner lift-off.
...
width with a pitch of 1200 \(\mu\)m between them, were patterned using
...
2023) or AZ\(^\circledR\) nLOF 2020 photoresist (post-Mar 2023).
...
height profile. As with the alignment markers deposition (see
Section~\ref{sec-align}), before Jun 2022 chromium was used for the gold
adhesive layer, and after Jun 2022 titanium was used.
