...
\hypertarget{carbon-nanotube-and-graphene-field-effect-transistor-as-biosensing-platforms}{%
\chapter{Carbon Nanotube and Graphene Field-Effect Transistor as
Biosensing
Platforms}\label{carbon-nanotube-and-graphene-field-effect-transistor-as-biosensing-platforms}}
...
1-Pyrenebutyric acid N-hydroxysuccinimide ester, PBSE, PBASE, PANHS) is
an aromatic molecule commonly used for tethering biomolecules to the
...
a carbon nanotube was first reported by Chen \emph{et al.} in 2001
{[}1{]}. Prior to this, only direct interactions between carbon
nanotubes and biomolecules had been reported.
...
\CSLLeftMargin{{[}1{]} }%
\CSLRightInline{R. J. Chen, {``Noncovalent sidewall functionalization of
single-walled carbon nanotubes for protein immobilization,''} \emph{J.
Am. Chem. Soc.}, vol. 123, pp. 3838--3839, Jan. 2001, doi:
