...
Characterisation}\label{sec-fluorescence-characterisation}}
...
Dye attachment was used to map the presence of PEGlyated pyrene-based
...
characterisation of linker attachment in this section.
...
\includegraphics{figures/ch7/labelled_modified_noencap_1mMPPF_channel2_1sexposure_6.3X_highcontrast_221214.png}
...
\includegraphics{figures/ch7/labelled_modified_noencap_1mMPPF_channel7_1sexposure_6.3X_highcontrast_221214.png}
...
as well as other linker molecules, are discussed further in the next
section.
...
\subsection{General Remarks}\label{sec-fluorescence-remarks}}
...
channel 2, (d) shows channel 3 and (e) shows channel 6. All images were
...
{\centering \includegraphics[width=0.45\textwidth,height=\textheight]{figures/ch7/modified_GFPOR_10sexposure_40X_mediumcontrast_ch1_231027.png}

}

\caption{\label{fig-PBASE-GFP-OR-0.1mM}Fluorescence image of a device
functionalised with 0.1 mM PBASE in methanol, followed by 10 \(\mu\)L/mL
GFP-OR43b nanodiscs in 1XPBS. As in Figure~\ref{fig-PBASE-GFP-ORs}, this
image was taken using an GFP filter and a 10 s exposure time.}
...
shown in \textbf{?@fig-PBASE-GFP-OR-ch3-zoom}-e.

As mentioned in Section~\ref{sec-fluorescence-characterisation}, dark
regions are the gold electrodes. There clearly appears to be an
attachment between the GFP-OR43b nanodiscs and the silicon dioxide
...
\textbf{?@fig-PBASE-GFP-OR-ch3-zoom}-e indicates GFP-OR43b nanodiscs are
...
\textbf{?@fig-PBASE-GFP-OR-ch6}, where nanodiscs appeared to be present
in excess on both the channel, SiO\(_2\), and even on the gold
...
were addressed, fluorescence microscopy was used to demonstrate
successful attachment of odorant receptors using a PBASE
functionalisation process. The device was modified in this process as
follows: submersion in 1 mM PBASE in methanol for 1 hour, then
