...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, sharp corners, frame hidden, interior hidden, enhanced, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\(-150\) mV measurement. It is possible that the amplitude of the
exponential term is history dependent and reduced by continuous
measurement.
...
shown in purple, was fabricated after Jun 2023. Device 2 was rinsed with
AZ\(^\circledR\) 326 developer and annealed at \(150^\circ\)C before
measurement. When taking control series measurements, the devices were
gated so that the current level for each control series would be as
similar as possible, as illustrated by the dotted lines in
Figure~\ref{fig-transfer-sweep-AZ1518}.
...
consistent across channels of a particular device type, with the size of
this term increasing with increased current across the channel. The time
constant of the exponential term appears to be intrinsic to the channel
being measured. It is not clear what decides the amplitude of the
exponential term, but there is some indication it may be
history-dependent. Realtime rapid exponential decay followed by slower
baseline drift has been observed previously for parallel arrangements of
carbon nanotubes in air, which \autocite{Noyce2019}
