...
\hypertarget{sensing-methods}{%
\subsection{Sensing Methods}\label{sensing-methods}}

\hypertarget{sec-biosensor-aqueous}{%
\subsubsection*{Aqueous Environment}\label{sec-biosensor-aqueous}}
\addcontentsline{toc}{subsubsection}{Aqueous Environment}

\hypertarget{sec-biosensor-vapour}{%
\subsubsection*{Vapour Environment}\label{sec-biosensor-vapour}}
...
2023) or AZ\(^\circledR\) nLOF 2020 photoresist (post-Mar 2023). To
ensure the patterned areas were clean of photoresist after development,
they were exposed to O\(_2\) plasma at 50 W for 2-5 s or at 20 W for 25
s in the PE-50 plasma cleaner (Plasma Etch, Inc.) directly before being
loaded into the thermal evaporator.
...
carbon-nanotube transistors for biosensing is essential \ldots{} as
discussed in \textbf{?@sec-biosensor-aqueous}.
