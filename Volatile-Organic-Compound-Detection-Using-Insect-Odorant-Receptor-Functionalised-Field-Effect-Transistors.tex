...
\subcaption{\label{fig-steaming-method-top}Steaming method setup no lid}
\end{minipage}%
%
...
\subcaption{\label{fig-steaming-method-side}Steaming method setup with
lid}
\end{minipage}%

\caption{\label{fig-steaming-method}Steam-assisted method setup, top and
side view.}
...
\subcaption{\label{fig-dektat-adhesion-layer}Adhesion layer dektat}
\end{minipage}%
%
\begin{minipage}[t]{0.05\linewidth}
...
\subcaption{\label{fig-dektat-photoresist-used}Graphene channel after
photolithographically defined electrodes deposition and liftoff}
\end{minipage}%
...
photoresist was used for photolithographic patterning. A 10 nm adhesion
layer and 100 nm Au layer were used for both depositions to ensure a
consistent comparison. From Figure~\ref{fig-dektat-adhesion-layer}, we
find an measured Cr/Au electrode height of \(42\pm1\) nm and an measured
Ti/Au electrode height of \(48\pm2\) nm, slightly less than half the
respective heights stated on the Inficon Deposition Controller.
...
discussed in Appendix~\ref{sec-photolithography}. Using a Veeco Dektat
150 profiler
...
profile sidewalls, which avoids the formation of edge spikes. Therefore,
the negative resist profile is more suited to metal or metal oxide
deposition and lift-off processes, though the process is more sensitive
to human error due to requiring more processing steps than positive
resist \autocite{Microchemicals}. Finally, when it is suitably processed
SU-8 is considered to be more biocompatible than other photoresists. It
is especially biocompatible when chemically modified via processes such
as isopropanol sonication and O\(_2\) plasma treatment
\autocite{Chen2021}.
