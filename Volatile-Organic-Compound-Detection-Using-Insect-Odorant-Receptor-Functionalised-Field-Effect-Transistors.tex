...
rapid succession. The sampling interval for each channel on the NI-PXIe
was 1.8 s, with a 2 ms delay between switching and measuring for each
channel per sample. The time between samples from each channel was set
automatically by NI-PXIe, between 220-230 ms. The other measurement
equipment used a 1 s sampling interval.
