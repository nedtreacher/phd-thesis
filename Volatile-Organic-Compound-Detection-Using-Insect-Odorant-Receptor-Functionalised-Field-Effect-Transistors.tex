...
\subsection{Comparing Deposition
...
nanotube film, discussed further in Section~\ref{sec-solvent-afm}. Such
...
\hypertarget{sec-solvent-afm}{%
\subsection{Presence of Solvent on Carbon
Nanotubes}\label{sec-solvent-afm}}
...
\includegraphics{./figures/ch5/Danica_NTQ14D6_90sCNT_20220915_00596.png}

}

}

\subcaption{\label{fig-pristine-afm}Pristine surfactant deposited
device}
\end{minipage}%
%
\begin{minipage}[t]{0.05\linewidth}
...
\includegraphics{./figures/ch5/Danica_NTQ14D6_DMSO_W4_20220915_00607.png}

}

}

\subcaption{\label{fig-DMSO-afm}Surfactant-deposited device after 1 hour
submersion in DMSO}
\end{minipage}%
\newline
\begin{minipage}[t]{0.26\linewidth}
...
\includegraphics{./figures/ch5/Danica_NTQ14D7_1mMPBASE_W4_20220915_00610.png}

}

}

\subcaption{\label{fig-DMSO-PBASE-afm}Surfactant-deposited device after
1 hour submersion in DMSO containing 1 mM dissolved PBASE}
\end{minipage}%
%
\begin{minipage}[t]{0.26\linewidth}
...
and after exposure to dimethyl sulfoxide (DMSO) and after exposure to
DMSO containing 1 mM 1-pyrenebutanoic acid n-hydroxysuccinimide ester
(PBASE).}
...
\includegraphics{./figures/ch5/Danica_NTQ14D6_90sCNT_20220915_00596_histogram.png}

}

}

\subcaption{\label{fig-pristine-histogram}Pristine surfactant-deposited
device}
\end{minipage}%
%
\begin{minipage}[t]{0.05\linewidth}
...
\includegraphics{./figures/ch5/Danica_NTQ14D6_DMSO_W4_20220915_00607_histogram.png}

}

}

\subcaption{\label{fig-DMSO-histogram}Surfactant-deposited device after
1 hour submersion in DMSO}
\end{minipage}%
\newline
\begin{minipage}[t]{0.26\linewidth}
...
\includegraphics{./figures/ch5/Danica_NTQ14D7_1mMPBASE_W4_20220915_00610_histogram.png}

}

}

\subcaption{\label{fig-DMSO-PBASE-histogram}Surfactant-deposited device
after 1 hour submersion in DMSO containig 1 mM dissolved PBASE}
\end{minipage}%
%
\begin{minipage}[t]{0.26\linewidth}
...
\caption{\label{fig-afm-solvent-histograms}Surface profile histograms
extracted from the 2.5 \(\mu\)m x 2.5 \(\mu\)m atomic force microscope
images seen in Figure~\ref{fig-afm-solvent}, each fitted with a linear
combination of normal distributions. Component normal distributions
corresponding to each linear combination are also shown.}
