...
carbon nanotube bundles decays to approximately zero before reaching 0
...
and \#2 have been subtracted from the AFM histogram are shown in blue.}

\end{figure}

By subtracting the modelled silicon and carbon nanotube normal
distributions from the AFM histogram, we find a remaining

The first or left-most distribution for all three figures in
