...
New different photolithography masks were used for encapsulation
...
and had an unencapsulated region of 500 \(\mu\)m x 10 \(\mu\)m for each
channel. The second mask was used exclusively after Jan 2023, and had an
unencapsulated region of 200 \(\mu\)m x 20 \(\mu\)m for each channel.
This change was made to double the area of carbon nanotubes exposed to
electrolyte while halving the area of SiO\(_2\) dielectric exposed to
electrolyte during aqueous sensing. A side-by-side microscope comparison
of hardbaked AZ\(^\circledR\) 1518 processed with each mask is given in
