...
To verify the sensitivity of the fabricated devices and therefore verify
their suitability for sensing, control measurements replicating a
typical sensing experiment were taken with a pristine device. To check
device sensitivity without first functionalising the channels, the
response to successive dilutions of liquid-gate electrolyte was
measured. A device with a steam-assisted, surfactant-deposited carbon
nanotube network was used due to the high electrical consistency between
channels as discussed previously. The total interval for the control
series was 1800 s, with 20\(\mu\)L 1XPBS additions at 100 s, 200 s and
...
settle. Figure~\ref{fig-transfer-sweep} shows the transfer sweep of a
single channel of a steam-assisted surfactant-deposited device
encapsulated with SU8, fabricated after Jun 2023. The threshold voltage
of the channel is \(V_{\textrm{th}}\) = 140 mV, and the voltage
corresponding to minimum current is \(V_{\textrm{gap}}\) = 310 mV. The
variable symbol V\(_{\textrm{gap}}\) denotes the center of the
transistor bandgap, has been labeled in this manner to be consistent
with previous work \autocite{Heller2009}.
