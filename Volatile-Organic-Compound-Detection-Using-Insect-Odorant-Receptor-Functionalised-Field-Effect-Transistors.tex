...
Non-covalent binding is weaker than covalent binding. However, the
advantage of non-covalent binding is that it disrupts the structure of
the nanomaterial less than covalent bonding does, and therefore has less
of a negative impact on the electrical properties of the transducer
\autocite{DiCrescenzo2014}. For example, one group found covalent
bonding of diazonium linker caused a \(\sim 50 %
\) drop in channel mobility \autocite{Lerner2014}. In particular, this
thesis discusses \(\pi-\pi\) bonding, a particular strong type of
...
using Gaussian 16 \autocite{g16}). The difference between computed
