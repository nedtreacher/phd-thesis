...
Subsequent additions may be more likely to cause adequate mixing,
leading to the change in concentration at the surface of the channel
being more representative of the overall concentration in the well.
...
current,
Figure~\ref{fig-salt-conc-detrend}, Figure~\ref{fig-salt-conc-detrend-filter}
become (e) and (f) respectively.}

\end{figure}

In Figure~\ref{fig-salt-conc-detrend} and
Figure~\ref{fig-salt-conc-detrend-filter}, we see that from roughly the
second deionised water addition onwards, the drift behaviour of
individual channels begin to significantly diverge from each other.\\
An alternative way of presenting the signal
