...
\hypertarget{photolithography-for-carbon-nanotube-and-graphene-field-effect-transistor-fabrication}{%
\section{Photolithography for Carbon Nanotube and Graphene Field-Effect
Transistor
Fabrication}\label{photolithography-for-carbon-nanotube-and-graphene-field-effect-transistor-fabrication}}
...
wafer is shown in Figure~\ref{fig-qw-photolithography}. Thermal
evaporation was used when depositing chromium (Cr) and gold (Au), while
electron beam evaporation was used when depositing titanium (Ti) and
metal oxides (\emph{e.g.} Al\(_2\)O\(_3\)). Metal and metal oxide
deposition was performed using an Angstrom Engineering Nex Dep 200
evaporator
...
steps. For carbon nanotube quarter wafers, alignment markers were
...
cleaving. AZ\(^\circledR\) 1518 was used for thi
