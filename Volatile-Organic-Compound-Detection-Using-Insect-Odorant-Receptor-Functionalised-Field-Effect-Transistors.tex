...
are especially sizable in the lower half of
Figure~\ref{fig-working-OR22a-AFM} (c), with the two largest clusters
measured to be \(200\pm10\) nm across at their widest point. However,
these features are still much smaller than the nanodisc aggregated
...
network and not simply sticking to each other may be an important
indicator that a sensor channel has been successfully functionalised.
