...
to dissolve poorly in methanol at higher concentrations. Subsequent
publications appear to have largely either chosen or slightly adapted
one of these two methods, as outlined in
Table~\ref{tbl-pbase-functionalisation}.
...
\caption{\label{tbl-pbase-functionalisation}Comparison of PBASE functionalisation processes used for liquid-gated
CNTFET and graphene FET sensors }\tabularnewline
...
DMSO & CNTs & 10 & - & 1 & DI water & Lopez et al. \\ 
 ...
 & Graphene & 10 & Immersed & 2 & DMSO, ethanol, DI water & Yue et al. \\ 
\bottomrule
\end{longtable}
