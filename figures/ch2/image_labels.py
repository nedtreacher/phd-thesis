...
def add_sidebar(image_path, label, ratio_size):
    ...
    sidebar_width = (height * width // 50500) // ratio_size
    font_size = (height * width // 110000) // ratio_size
...
if __name__ == "__main__":
    ...
    image_labels = [
        ("back-gate-schematic.png", "(a)", 0.5),
        ("liquid-gate-schematic.png", "(b)", 0.5)  # Example of different ratio size
    ]
