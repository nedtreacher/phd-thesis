...
Linker molecules may be attached via covalent or non-covalent bonding to carbon nanomaterials, such as carbon nanotubes and graphene. Non-covalent bonding is weaker than covalent bonding. However, the advantage of non-covalent bonding is that it disrupts the structure of the nanomaterial less than covalent bonding does, and therefore has less of a negative impact on the electrical properties of the transducer [@DiCrescenzo2014]. For example, one group found covalent bonding of diazonium linker caused a $\sim 50 %$ drop in channel mobility [@Lerner2014]. In particular, this thesis discusses $\pi-\pi$ bonding, a particular strong type of non-covalent bonding.
