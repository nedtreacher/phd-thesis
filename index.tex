...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, sharp corners, frame hidden, borderline west={3pt}{0pt}{shadecolor}, interior hidden, breakable]}{\end{tcolorbox}}\fi
...
negative shift indicates that the presence of the EDC/NHS has n-doped
the carbon nanotube network, which likely results from the formation of
a positively-charged \emph{O}-acylisourea active ester from the PBA
attached to the carbon nanotubes \autocite{Heller2008,Hermanson2013-4}.
...
dyes themselves interacted with the graphene carbon rings.
...
carbon rings \autocite{Tang2012}. As it is the attachment of pyrene
which is of interest, rather than attachment of the fluorescent
modifier, fluorescein isothiocyanate was used for mapping linker
attachment instead of Rhodamine B. Figure~\ref{fig-PPF-concs} shows
various concentrations of pyrene-PEG-FITC dissolved in 1XPBS, which is
used for fluorescence characterisation in this section.
