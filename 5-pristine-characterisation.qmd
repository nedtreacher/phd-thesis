...
To verify the sensitivity of the fabricated devices and therefore verify their suitability for sensing, control measurements replicating a typical sensing experiment were taken with a pristine device. To test device sensitivity without first functionalising the channels, the response to successive dilutions of liquid-gate electrolyte was measured. A device with a steam-assisted, surfactant-deposited carbon nanotube network was used due to the high electrical consistency between channels as discussed previously. The total interval for the control series was 1800 s, with 20$\mu$L 1XPBS additions at 100 s, 200 s and 300 s, and 20$\mu$L subtractions at 400 s, 500 s and 600 s. The device was left untouched over the next 1200 s to allow the current level to settle. @fig-transfer-sweep shows the transfer sweeps of the six working channels of a steam-assisted surfactant-deposited device encapsulated with AZ$^\circledR$ 1518, fabricated in Mar 2023 and measured using the PXIe. The threshold voltage of the channels are $V_{\textrm{th}}$ = .
