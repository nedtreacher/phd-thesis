...
@fig-bg-baseline-drift (a) shows 3600 s of baseline drift from the same channel when the device was backgated at V$_g$ = 0 V and a source-drain voltage of V$_{ds}$ = 100 mV was placed across the channel. During this period of time, a 200 sccm nitrogen flow was placed through the device chamber with the dilution mass flow controller. Gate leakage current remains negligible across the entire control series. As seen for the liquid-gated device in @sec-baseline-drift, there is a period of rapid exponential decay followed by a period of stable, approximately linear baseline drift. The baseline drift observed appears to be significantly lower than that seen by Noyce *et al.* [@Noyce2019]. This observation suggests that their larger drift is not a result of backgating in air, as previously suggested, but instead due to their use of a significantly different fabrication process.
