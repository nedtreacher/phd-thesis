...
Photolithography was used to define eight channel regions on each device and subsequently to define metal contacts for each of these channels. Each channel region was 1000 $\mu$m in length and 100 $\mu$m in width. A schematic demonstrating these photolithography processes on a quarter wafer is shown in @fig-qw-photolithography.
...
For carbon nanotube quarter wafers, markers were deposited either directly before or after carbon nanotube deposition (see @sec-dep-carbon-nanotubes for discussion). For graphene devices, alignment markers were deposited directly after cleaving without  
