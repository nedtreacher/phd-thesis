...
Graphene consists of sp$^2$-bonded carbon in a lattice of hexagonal cells. It is a zero band gap material as its conduction and valence bands meet at the Fermi level [@Heller2010].
...
When a gate voltage $V_g$ is applied to the channel of a graphene device, the number and mobility of charge carriers available for conduction is altered. Diffusive, rather than ballistic transport of carriers dominates.
