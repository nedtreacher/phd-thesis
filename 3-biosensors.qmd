...
In @sec-thin-film-transistors, it was established that as carbon nanotubes and graphene are highly sensitive and are easily modified with biomaterials, they make an ideal platform for biosensing [@Kauffman2008; @Ohno2010]. In the early 2000s, it was established that sensitive and selective biosensors could be created by modifying a carbon nanotube field-effect transistor channel with protein receptors [@Chen2003; @Kauffman2008]. In the following two decades, a wide range of other biological receptors have been attached to carbon nanotube FETs and graphene FETs into biosensors, including enzymes, antibodies and aptameric DNA [@Star2006]. These miniaturised 'lab on a chip' devices are of particular interest due to their low cost, rapid use time, simple operation and small size compared with more traditional biological analysis methods [@Kauffman2008]. It is hoped that these sensors could be deployed outside the laboratory in a range of front-line settings requiring rapid and reliable detection. Examples include rapid diagnostic testing at a busy medical clinic [@Lim2014], or biological threat detection across a large shipment of imported fruit [@B3; @Queensland].

A bifunctional linker element may mediate the attachment between bioreceptor and transducer in a biochemical process referred to as functionalisation [@Star2003a]. Functionalisation may either involve stronger covalent bonding or weaker non-covalent bonding. Functionalisation is discussed in more detail in @sec-noncovalent-functionalisation.
to the carbon-ring surface through a linker  functional groups of the receptor elements 

Rapid developments in this biosensor technology and parallel developments in the understanding of animal olfaction led to studies in the late 2000s onwards which investigated the use of these transistors in the creation of a bioelectronic nose [@Yoon2009; @Jin2012; @Lee2012b; @Park2012]. 

'Bioelectronic nose' is a general term which refers to the use of an electronic array to detect specific odor traces in a highly sensitive manner. External monitoring equipment can then interface with this bioelectronic nose to record and analyse odor response signals. As the name suggests, the resulting signals should be highly similar to the electrochemical signals received by olfactory neurons in an animal nose [@Dung2018]. Metal oxide transistors were first used to detect odorants in a mammal-like bioelectronic nose in the early 1980s [@Persaud1982]. A biomimetic approach to bioelectronic nose development couples elements of the animal olfactory system, either odorant binding proteins (OBPs) [@Larisika2015; @Kotlowski2018] or odorant receptor proteins (olfactory receptors, ORs) [@Yang2018] to the CNT FET or GFET signal-amplifying transducer element.   
