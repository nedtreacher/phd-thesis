...
As carbon nanotubes and graphene are highly sensitive substances and are easily functionalised with biomaterials, they make an ideal platform for biosensing [@Ohno2010; @Goodwin2021]. Through the early 2000s, a variety of biologically functionalised...

Nature-based approaches incorporating elements of the animal olfactory system, including odorant binding proteins (OBPs) [@Larisika2015] and odorant receptors (olfactory receptors, ORs) [@Yoon2009; @Lee2012b], emerged in the late 2000s and early 2010s.   
...
Non-specific binding (NSB) refers to any attachment to the sensor channel not related to the specific analyte of interest which could interfere with sensing. Liquid-gated graphene and carbon nanotube devices are highly sensitive to the approach of charge within the Debye length of the device channel [@Shkodra2021]. Non-specific adsorption of the analyte or ambient contamination by numerous elements of the setup can lead to signal responses not attributable to the mechanism of interest (see @sec-CNT-sensing-mechanisms), leading to false positives when sensing [@Chen2004; @Shkodra2021]. These elements include the channel itself, but can also include the source-drain and gate electrodes [@Chen2004]. A variety of measures can be taken to prevent NSB from occurring. Once bioreceptors have been attached to the channel, remaining exposed carbon nanotubes can be passivated with chemical coatings such as Tween-20 and ethanolamine. If measuring multiple channels in a multiplexed array, one channel can be left uncoated to compare the sensing response in a process known as 'internal referencing' [@Shkodra2021].
