...
Liposomes and micelles are shown in (a) with the hydrophilic heads and hydrophobic tails indicated (figure adapted from [@Micelle]). A lipid nanodisc wrapped around an insect odorant receptor transmembrane protein is shown in (b), where the amine group shown is the odorant receptor N-terminus (reproduced with permission from [@Murugathas2019a]). The nanodisc consists of a lipid bilayer and membrane scaffold protein (MSP).
:::
