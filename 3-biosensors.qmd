...
```{r}
#| tbl-cap: A comparison of the advantages and disadvantages of different approaches for immobilising odorant receptors onto thin-film transducers. High simplicity = low resources, time and effort required for functionalisation $-$ High synergy = receptor attachment does not negatively impact transducer or receptor behaviour $-$ High stability = successful device operation over a long time and under a range of conditions $-$ High specificity =  controlled and directional receptor attachment $-$ High strength = strong receptor-transducer binding.
