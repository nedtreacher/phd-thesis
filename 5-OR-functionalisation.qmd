...
![Sigma NMR](figures/ch5/sigma_pbase_nmr.png){#fig-sigma-nmr}

![Setareh NMR](figures/ch5/setareh_pbase_nmr.png){#fig-setareh-nmr}

 ![Blank (DMSO only) NMR](figures/ch5/dmso_nmr.png){#fig-dmso-nmr}

 Comparison of NMR spectrum profiles
