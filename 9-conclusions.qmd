...
Ionic liquids (ILs) have recently attracted particular interest as an high-quality liquid-gate electrolyte for biosensor applications [@Dung2018]. These ionic liquids have low vapour pressure, high capacitance, as well as high electrochemical stability. 1-Butyl-3-methylimidazolium bis(trifluoromethylsulfonyl)imide (BMIM) is one example of an ionic liquid which has previously been used as the electrolytic gate for thin-film field-effect transistors [@Hwang2014; @White2015]. 
