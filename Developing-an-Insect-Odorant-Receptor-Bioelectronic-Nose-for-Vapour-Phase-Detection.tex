...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced, frame hidden, interior hidden, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
...
odorant receptors show a logarthmic electrical response to low
...
measurements do not conflict with previous observations of a logarthmic
...
and subsequently modified with pyrene-PEG-biotin, as described in
\textbf{?@sec-NTA-biotin-PEG}, allowing them to attach directly from
solution to the carbon nanotubes via the pyrene linker. The
preattachment of odorant receptors to linker means that this approach
must be entirely performed in aqueous solution, but ensures no PBASE or
PBA was needed in the functionalisation process. To eliminate the
hydrocarbonaceous coating of nanotubes and ensure aqueous
