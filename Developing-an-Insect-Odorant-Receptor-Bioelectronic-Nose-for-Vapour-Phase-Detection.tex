...
\caption{\label{fig-membranes}Liposomes and micelles are shown in (a)
...
lipid bilayer and membrane scaffold protein (MSP).}
...
for immobilising odorant receptors onto thin-film transducers. High
simplicity = low resources, time and effort required for
functionalisation \(-\) High synergy = receptor attachment does not
negatively impact transducer or receptor behaviour \(-\) High stability
= successful device operation over a long time and under a range of
conditions \(-\) High specificity = controlled and directional receptor
attachment \(-\) High strength = strong receptor-transducer binding. }\tabularnewline
