...
\textbf{?@sec-photoresist-contamination}). The SiO\(_2\) substrate also
appears brighter in the images on the right of
...
indicates that the pyrene moiety of PBASE interacts with the SiO\(_2\)
substrate. Assuming no significant variation in the fluorescence of GFP
between nanodisc vials, the PBASE coating appears have led to more
nanodiscs attaching to the SiO\(_2\), giving rise to the brighter
fluorescence of the SiO\(_2\) seen for the PBASE-incubated device on the
right of Figure~\ref{fig-PBASE-GFP-ORs}.
