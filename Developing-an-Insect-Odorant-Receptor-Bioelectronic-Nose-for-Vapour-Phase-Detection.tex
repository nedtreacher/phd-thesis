...
{\centering \includegraphics[width=0.6\textwidth,height=\textheight]{figures/ch3/pyrene-cnt.png}
...
alongside chloroform and dimethyl sulfoxide (DMSO).
...
recommended storage of -5 to -30°C alongside protection from light and
...
are shown in (c) and (d) respectively. The threshold voltage for the
forward sweep of each transfer characteristic curve is also shown.}
...
nanotubes has occurred \autocite{Wei2010,Lan2013}. Wei \emph{et al.}
\autocite{Wei2010} found functionalisation with PBASE altered the ratio
by a factor of \(\sim 1.5 \times\), while Lan \emph{et al.}
