...
and dissociation of the G-protein within the neuronal cell.
Intracellular signalling events triggered by G-protein dissociation are
converted to an action potential which is then transmitted to the brain
\autocite{Buck1991,Glatz2011,Zhang2021}. The combination of activated
receptors is then interpreted as a specific odor
\autocite{Sato2014,Kwon2015,Hurot2020,Kim2022a}. Odorant receptors may
be activated by a few or many target (or `agonist') compounds. The
...
respectively. Blobs are seen across the surface of the
post-functionalisation image which are tens of nanometers in height. On
the nanotube network, these blobs are seen directly next to nanotube
...
appears that these blobs are large agglomerates of nanodiscs
...
attachment to a sticky substrate and electrostatic binding to any
charged surface present, such as the reference electrode
...
\autocite{Chen2004}, PEG \autocite{Star2003a,Lee2012b}, and ethanolamine
