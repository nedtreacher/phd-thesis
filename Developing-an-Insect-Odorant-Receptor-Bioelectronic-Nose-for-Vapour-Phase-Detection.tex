...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, sharp corners, borderline west={3pt}{0pt}{shadecolor}, frame hidden, enhanced, interior hidden, breakable]}{\end{tcolorbox}}\fi
...
eliminate these infestations. The sensor could then be used to prevent
cross-border incursions by the Queensland fruit fly, which have
historically cost the New Zealand government millions of NZD to address
\autocite{Queensland1,Queensland2}.
...
described in \textbf{?@sec-biosensing-iORs}. The most successful
...
trialled in \textbf{?@sec-biosensing-iORs} were unable to produce
...
\textbf{?@tbl-RHI-flow-sequence} (\(t\) = time, \(C\) = carrier line
...
{\centering \includegraphics[width=0.75\textwidth,height=\textheight]{figures/ch9/input_time_comparison_PID.png}
...
impact of this variability on the vapour delivered to the chamber should
be considered when reviewing the results in the rest of this chapter,
