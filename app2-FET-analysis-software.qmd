...
## Atomic Force Microscope Histogram Analysis
...
Using the objective function with these fitting parameters in the scipy.optimize.curve_fit module, we receive optimised fitting parameters which gave an R-squared value of 0.999 or greater.